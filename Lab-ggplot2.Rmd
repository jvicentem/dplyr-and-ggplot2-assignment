...
flights %>%
  select(year, origin, flight) %>% # Quizás no sea necesario seleccionar la variable "year" ya que los datos con los que trabajamos son únicamente del 2013, es decir, hay datos de un sólo año
